...
import type { DeliveryInfo, DeliveryType } from "@/lib/types"
...
export default function CartPage() {
  ...
  const handleCheckout = () => {
    ...
    if (deliveryType === "entrega") {
      if (!deliveryInfo.rua || !deliveryInfo.numero || !deliveryInfo.bairro || !deliveryInfo.cidade) {
            ...
            <Card className="p-6 sticky top-4 mx-auto max-w-md md:max-w-none">
              ...
              <div className="border-t pt-4 mt-4">
                ...
                <Button
                  ...
                  size="lg"
                  disabled={!paymentMethod || !deliveryType || (deliveryType === "entrega" && (!deliveryInfo.rua || !deliveryInfo.numero || !deliveryInfo.bairro || !deliveryInfo.cidade))}
                >
